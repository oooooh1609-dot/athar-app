...
const line = { id: "1", kind: "length", points: [{ x: 0, y: 0 }, { x: 300, y: 400 }], label: "" };
...
const diag = { id: "5", kind: "length", points: [{ x: 0, y: 0 }, { x: 300, y: 400 }], label: "" };
...
eq("zero-length reference", mmPerPixel({ a: { x: 5, y: 5 }, b: { x: 5, y: 5 }, realMm: 100 }), null);
eq("negative real length", mmPerPixel({ a: { x: 0, y: 0 }, b: { x: 10, y: 0 }, realMm: -5 }), null);
eq("area with 2 points", evaluate({ id: "6", kind: "area", points: rect.points.slice(0, 2), label: "" }, ref), null);
