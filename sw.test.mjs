...
// Cross-origin.
is("third-party script", chooseStrategy(new URL("https://cdn.other/x.js"), "no-cors", "GET", ORIGIN), "passthrough");
is("supabase call", chooseStrategy(new URL("https://xyz.supabase.co/rest/v1/t"), "cors", "GET", ORIGIN), "passthrough");
is("google fonts css", chooseStrategy(new URL("https://fonts.googleapis.com/css2?family=X"), "cors", "GET", ORIGIN), "font");
is("gstatic font file", chooseStrategy(new URL("https://fonts.gstatic.com/s/a.woff2"), "cors", "GET", ORIGIN), "font");
is("font host but POST", chooseStrategy(new URL("https://fonts.gstatic.com/s/a.woff2"), "cors", "POST", ORIGIN), "passthrough");
